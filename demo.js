...
// function to load the Gcode file when hosted
...
// update button function for keeping the up to date Gcode in the renderer
function Update() {
  try {
...
//clens the code editor for new gcode
function Clean() {
  try {
    gcodePreview.clear();
    originalGcode = editor.getValue();
...
//function associated with cleaning the code 
...
//populates the editor with the Gcode
